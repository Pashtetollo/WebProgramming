...
import { createFruit, FruitCardStorage } from "components/FruitStorage/FruitStorage";
...
export const getFruitCards = (fruitList, bonusFunc = () => undefined) => {
  return fruitList.map((fruit) => createFruit(fruit, bonusFunc(fruit)));
}
